...
public class DispalyCardActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.val.tdx.artactivities.R.layout.activity_display_card);
        ...
        titleText = (TextView) findViewById(com.val.tdx.artactivities.R.id.card_title);
        descriptionText = (TextView) findViewById(com.val.tdx.artactivities.R.id.card_description);
        materialsText = (TextView) findViewById(com.val.tdx.artactivities.R.id.card_materials);
        directionsText = (TextView) findViewById(com.val.tdx.artactivities.R.id.card_directions);

        cardImage = (ImageView) findViewById(com.val.tdx.artactivities.R.id.card_imageView);
