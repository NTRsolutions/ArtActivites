...
public class SearchScreenActivity_old extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.val.tdx.artactivities.R.layout.activity_search);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        btnSearch = (Button)findViewById(com.val.tdx.artactivities.R.id.buttonSearchSubmit);
        btnSearch.setOnClickListener(this);
        searchName = (EditText) findViewById(com.val.tdx.artactivities.R.id.editTextSerachName);
        searchMaterials = (EditText) findViewById(com.val.tdx.artactivities.R.id.editTextSearchMaterials);
    }
